# Triton / TRISIS / HatMan (August 2017, Saudi petrochemical) — Authorization Context Analysis
...
- FireEye / Mandiant, "Attackers Deploy New ICS Attack Framework 'TRITON' and Cause Operational Disruption to Critical Infrastructure" (2017-12-14)
- Dragos, "TRISIS Malware: Analysis of Safety System Targeted Malware" (2017-12)
- ICS-CERT / CISA, MAR-17-352-01 "HatMan: Safety System Targeted Malware"
- FireEye, "TRITON Attribution: Russian Government-Owned Lab Most Likely Built Custom Intrusion Tools for TRITON Attackers" (2018-10-23)
- U.S. Department of the Treasury, "Treasury Sanctions Russian Government Research Institution Connected to the Triton Malware" (2020-10-23) — first U.S. sanctions for ICS-safety-system-targeting operation
- CISA AA20-227A, "Russian Government Cyber Operations" (2020-10-23) — TsNIIKhM attribution
- Schneider Electric, Triconex Security Advisory and subsequent firmware guidance (2017–2018)
- Joe Slowik (Dragos), "Evolution of ICS Attacks and the Prospects for Future Disruptive Events" — places Triton in the Stuxnet → Industroyer → Triton → Pipedream progression
- Corpus cross-references: `stuxnet.md` (physical-kinetic authorization, process-layer attack), `volt_typhoon.md` (standing-option occupation of critical infrastructure), `sunburst.md` (trust-layer targeting at identity vs. at safety-interlock layer)
